...
#define PeripheralMAC	001EC024963A
...
void Wait_Connection(char *bufPt){
		while ((CONN & 0x20) == 0){};			// check CONN input from the BTLE module, wait while CONN = 0, move on when connection is established
